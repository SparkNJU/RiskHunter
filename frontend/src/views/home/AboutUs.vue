...
const FinaImages = {
    wyf: new URL('../../assets/teamMembers/Fn1_wyf.jpg', import.meta.url).href,
    llt: new URL('../../assets/teamMembers/Fn2_llt.jpg', import.meta.url).href,
    gyx: new URL('../../assets/teamMembers/Fn3_gyx.jpg', import.meta.url).href,
