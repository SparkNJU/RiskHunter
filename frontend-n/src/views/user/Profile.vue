...
<template>
  <el-main class="main-container profile-container">
    <!-- 个人信息卡片 -->
    <el-card class="profile-aside" shadow="hover">
    ...
    <!-- 个人信息修改卡片 -->
    <el-card v-if="displayInfoCard" class="profile-main" shadow="hover">
      <template #header>
    ...
    <!-- 密码修改卡片 -->
    <el-card v-else class="profile-main" shadow="hover">
      <template #header>
        <div class="profile-header">
