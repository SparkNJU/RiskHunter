...
#### Enhanced V-Model Implementation
```mermaid
graph TD
...
## 2. Module Testing (Black-Box)
### 2.1 User Management Module
#### 2.1.1 User Registration API
```http
...
### 2.2 Risk Signal Module
#### 2.2.1 Signal Creation API
```http
...
## 3. Unit Testing (White-Box)
### 3.1 DAO Layer Tests
#### 3.1.1 RiskSignalMapper Test
```java
@Test
...
#### 3.1.2 Transaction Rollback Test
```java
@Transactional
@Test
...
## 4. Integration Testing (API Contract)
### 4.1 Risk Signal Advanced Search
```http
...
## 6. System Testing (E2E)
### 6.1 Core Business Flow
```mermaid
sequenceDiagram
    participant User
